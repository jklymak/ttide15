...
The response of the forcing in the most complex domain motivates the more idealized experiments that follow.  From the initial forcing (\fref{fig:VelFluxReal1km03}a), a complex wavefield develops with clear scattering from the Tasman Rise, the shelf, and numerous small inhomogeneities on the sea floor (\fref{fig:AbsFluxReal1km03}b--d).  Looking along shelf, the phase of the velocity signal can be seen changing approximately every 200 km, and it changes approximately every 100 km offshelf.  
...
\begin{figure*}[htbp]
  \begin{center}
    ...
    \caption{Mode-1 decomposition of energy fluxes for the \mn{Shelf} experiment.  
      \tempS{\footnotesize /Users/jklymak/ttide/ProcessHaiseTas3d.ipynb ;     
