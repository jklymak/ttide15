...
\frame{\frametitle{Setup}
  \begin{center}
   \includegraphics<1>[width=1.1\textwidth,trim=0 0 0 0, clip]{doc/AnalyticalForcing}
  \end{center}
      \begin{itemize}
...
\framesubtitle<2>{Energy Budget}
\begin{center}
  \includegraphics<1>[width=0.85\textwidth,trim=0 0 0 0, clip]{doc/VelFluxReal1km03.pdf}
  \includegraphics<2>[width=0.85\textwidth,trim=0 0 0 0, clip]{doc/DissReal1km03cycle20.pdf} 
\end{center}
}
